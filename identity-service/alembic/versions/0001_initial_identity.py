...
def upgrade() -> None:
    ...
    op.create_index("ix_service_apps_code", "service_apps", ["code"])
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.ForeignKeyConstraint(["service_id"], ["service_apps.id"]),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("code"),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("user_id", "role_id", "branch_id", "department_id"),
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_service_apps_code", table_name="service_apps")
